...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/code-x",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/code-x.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/code-x/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called code-x which is linked to
    //./bin/code-x in the local package.

    //If we have installed this package globally using npm install code-x
    //-g we will be able to call this new command code-x from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/code-x.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/code-x.js"
    }
};
